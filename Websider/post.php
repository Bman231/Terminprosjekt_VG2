...
try {
    ...
    // Feilmelding hvis det oppstår feil
    exit('Failed to connect to database!');
}

// Funksjonen under gjør om dato og tid til tid som har gått siden publisering
function time_elapsed_string($datetime, $full = false) {
    ...
    return $string ? implode(', ', $string) . ' siden' : 'akkurat nå';
}
...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <textarea name="content" placeholder="Skriv din post..." required></textarea>
...
if (isset($_GET['page_id'])) {
    ...
    exit('Ingen Page ID er spesifisert!');
}
?>
